...
SVM
  ...
  Weights were divded into quartiles deciles, . Genes expressed in the outer two quantiles at the 25%, 20%, 1% and 0.1%. The identified genes in the .1% quartile were not found to be associated with known AML gnes. Higher quartiles may, simply by virtue of size. It may be that, combined with other approaches an effective way to use ML to identify significant variants could be found.
