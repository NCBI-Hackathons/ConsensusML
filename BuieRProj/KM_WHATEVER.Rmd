...
GroupMatching$KM <-  GroupMatching$`4_k`
GroupMatching$`4_k` <- NULL

CleanedWithGenesKM4 <- merge(CleanedWithGenes, GroupMatching, by = "TARGET.USI", all.x = TRUE)
...
Weights were divded into quartiles. Genes expressed in the outer two quartiles recorded for further analysis
