...
![Comparison of median rank measures (naive vs. normalized) across 4 algorithms (lasso: green, XGBoost: blue, Random Forest: orange, and SVM: red). ](rankcompare_4algo.jpg)
...
![Feature classification summary across Boruta Bootstraps with Consensus importance ("nrank").](bbs-nrank_compplot.jpg)
![Feature classification summary across Boruta Bootstraps with Lasso importance.](bbs-lasso_compplot.jpg)
![Feature classification summary across Boruta Bootstraps with Random Forest importance.](bbs-rf_compplot.jpg)
![Feature classification summary across Boruta Bootstraps with SVM importance.](bbs-svm_compplot.jpg)
![Feature classification summary across Boruta Bootstraps with XGBoost importance.](bbs-xgb_compplot.jpg)
## Feature Importance Histories Across Runs
...
![Feature overlap among features confirmed in at least 1 bootstrap, across bootstrap runs with 5 importance metrics.](nrank-4algo_gconfall_upsetr.jpg)

![Feature overlap among features confirmed in at least 5% of bootstrap runs, across bootstrap runs with 5 importance metrics](nrank-4algo_gconf5perc_upsetr.jpg)

![Feature overlap among features confirmed in at least 20% of bootstrap runs, across bootstrap runs with 5 importance metrics](nrank-4algo_gconf20perc_upsetr.jpg)
