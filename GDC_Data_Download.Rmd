...
knitr::opts_knit$set(root.dir = '/fh/scratch/delete90/meshinchi_s/Hackathon_2019/')
...
qfiles <- files(fields=c("cases.project.project_id",default_fields('files'), grep_fields('files', "associated_entities"), 
  ...
  filter(~ type == 'gene_expression' & 
          ...
          (cases.project.project_id == "TARGET-AML" | cases.project.project_id == "TARGET-NBL" | cases.project.project_id == "TARGET-WT")) 
