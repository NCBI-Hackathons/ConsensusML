...
#----------------------------------------
# upset with queries and gene symbol txt
#----------------------------------------
...
queries=list(list(query = intersects, 
                  params = list(colnames(tif.new)[grepl("novel",colnames(tif.new))]), 
                  color="red", 
                  active=TRUE))
grid.text(cxtype, x=0.2, y=0.95, gp=gpar(fontsize=15), col="red")
